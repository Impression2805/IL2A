...
parser.add_argument('--save_path', default='model_check/', type=str, help='save files directory')
...
def main():
    ...
    model = dualAug(args, file_name, feature_extractor, task_size, device)
